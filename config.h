...
static const char font[]            = "Source Code Pro Semi Bold 9";
...
/* tagging */
static const char *tags[] = { "东", "南", "北", "西" };

static const Rule rules[] = {
  /* class      instance    title       tags mask     isfloating   monitor */
  { "Gimp",     NULL,       NULL,       0,            True,        -1 },
  { "Firefox",  NULL,       NULL,       1 << 4,       False,       -1 },
  { "stalonetray", NULL,    NULL,       0x1ff,        True,        -1, True }, 
};
...
static const Layout layouts[] = {
  ...
  { "ㄷ",      tile },    /* first entry is default */
  { "ㅂ",      NULL },    /* no layout function means floating behavior */
  { "ㅁ",      monocle },
};
